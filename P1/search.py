...
def uniformCostSearch(problem):
    ...
    while not fringe.isEmpty():
        ...
        for nex in successors:
            if nex[0] in expandedNodes: continue
            nextPath = currentPath[:]
            nextPath.append((nex[0], nex[1], nex[2] + currentCost))
            fringe.push(nextPath, nex[2] + currentCost)
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    while not fringe.isEmpty():
        ...
        for nex in successors:
            ...
            nextPath = currentPath[:]
            nextPath.append((nex[0], nex[1], nex[2] + currentCost))
            fringe.push(nextPath, nex[2] + currentCost + heuristic(nex[0], problem))
