...
class InferenceModule:
    ...
    def getObservationProb(self, noisyDistance, pacmanPosition, ghostPosition, jailPosition):
        ...
        if noisyDistance is None: return 0
...
class ExactInference(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for position in self.allPositions:
            self.beliefs[position] = self.beliefs[position] * \
                                     self.getObservationProb(observation, pacmanPosition, position, jailPosition)
    ...
    def elapseTime(self, gameState):
        ...
        for oldPos in self.allPositions:
            ...
            for key, value in newPosDist.items():
                new_belief[key] += value * self.beliefs[oldPos]
...
class ParticleFilter(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for i in range(self.numParticles):
            weights[self.particles[i]] += self.getObservationProb(observation, pacmanPosition,
                                                                  self.particles[i], jailPosition)
    ...
    def getBeliefDistribution(self):
        ...
        self.beliefs = DiscreteDistribution()
        for i in range(self.numParticles):
            self.beliefs[self.particles[i]] += 1
        self.beliefs.normalize()
        return self.beliefs
...
class JointParticleFilter(ParticleFilter):
    ...
    def initializeUniformly(self, gameState):
        ...
        "*** YOUR CODE HERE ***"
        positions = self.legalPositions
        raw_positions = self.legalPositions
        for i in range(self.numGhosts - 1):
            positions = itertools.product(positions, raw_positions)
        i = 0
        all_positions = []
        for position in positions:
