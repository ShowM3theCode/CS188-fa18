...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        largestProb = 0
        '''
        for key, value in livingGhostPositionDistributions.items():
            if value > largestProb:
                largestProb = value
                mostLikelyPosition = key
        '''
        new_belief = inference.DiscreteDistribution()
        # print(len(livingGhostPositionDistributions))
        # print(type(livingGhostPositionDistributions[0]))
        ...
        for action in legal:
            ...
            distance = self.distancer.getDistance(successorPosition, mostLikelyPosition)
